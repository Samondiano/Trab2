...
public class q10 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Vetor_10</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Vetor Crescente: "+vetorCrescente+"</h1>");
            out.println("<h1>Vetor Decrescente: "+vetorDecrescente+"</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
